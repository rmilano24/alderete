...
<div id="cta-boxes">
	<div class="grid grid-cols-3 gap-8 container mx-auto mb-30">
		...
		<div class="mt-40">
			<div class="glass rounded-2xl border border-white/20 shadow-[0_4px_100px_0px_rgba(0,0,0,0.6)] flex flex-col justify-between p-8 w-full h-96">
				...
				<div class="text-3xl"><a target="_blank" href="tel:18314323231">831.432.3231</a></div>
			</div>
		</div>
		<div class="mt-40">
			<div class="glass rounded-2xl border border-white/20 shadow-[0_4px_100px_0px_rgba(0,0,0,0.6)] flex flex-col justify-between p-8 h-96">
				...
				<div class="text-3xl"><a target="_blank" href="tel:18314323231">2820 Daubenbiss Ave <br> Soquel, CA 95073</a></div>
			</div>
		</div>
		<div class="mt-40">
			<div class="glass rounded-2xl border border-white/20 shadow-[0_4px_100px_0px_rgba(0,0,0,0.6)] flex flex-col justify-between p-8 h-96">
				...
				<div class="text-3xl"><a href="mailto:dr.alderete@drconnect.net">dr.alderete@drconnect.net</a></div>
			</div>
		</div>
