...
<section id="forms" class="container py-50 mx-auto">
	...
	<div class="grid grid-cols-3 gap-48">
		<div id="left-col">
			...
			<p class="text-teal-100 mt-8 text-lg">We ask that you download and complete a form so that you have ample time to read it and can complete it thoroughly and accurately. If you have any questions regarding this form, please call us at 831.688.3930</p>
		...
		<div id="right-col" class="col-span-2 border-b border-teal-800">
			...
			<ul class="inline-block">
				<li class="inline-block"><a href="" class="py-5 px-8 bg-teal-400 text-blue-950 rounded-4xl">Download PDF</a></li>
				<li class="inline-block ml-3"><a href="" class="py-5 px-8 border border-teal-400 rounded-4xl text-teal-400">Download Word</a></li>
			</ul>
			</div>
